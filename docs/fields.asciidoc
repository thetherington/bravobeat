...
--
This document describes the fields that are exported by Bravobeat. They are
grouped in the following categories:

* <<exported-fields-beat-common>>
* <<exported-fields-bravobeat>>
