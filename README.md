...
`${GOPATH}/src/github.com/thetherington/bravobeat`
...
```
git remote set-url origin https://github.com/thetherington/bravobeat
...
in the same directory with the name bravobeat.
...
```
mkdir -p ${GOPATH}/src/github.com/thetherington/bravobeat
git clone https://github.com/thetherington/bravobeat ${GOPATH}/src/github.com/thetherington/bravobeat
```
